                ...
                <div className="row justify-content-center">
                    <div className="col-xl-12">
                        <SectionTitle className="text-center">
                            <SectionTitle.Name>Pricelist</SectionTitle.Name>
                            <SectionTitle.Title>Pricelist <span className="text-primary">Jasa Website</span></SectionTitle.Title>
                        </SectionTitle>
                    </div>
                </div>
        ...
        <SlideUp delay={id}>
            <div className="border border-border p-2.5 rounded-2xl">
                <div className="border border-border rounded-md lg:px-12.5 px-6 py-12">
                    ...
                    <h4 className="text-4xl text-primary font-DM-Sans">{price}</h4>
                </div>
